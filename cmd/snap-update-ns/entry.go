...
func XSnapdMode(e *osutil.MountEntry) (os.FileMode, error) {
...
// returned.
func XSnapdUID(e *osutil.MountEntry) (uid uint64, err error) {
...
// the mode is not specified explicitly then a default "root" use is
// returned.
func XSnapdGID(e *osutil.MountEntry) (gid uint64, err error) {
...
func XSnapdEntryID(e *osutil.MountEntry) string {
...
func XSnapdNeededBy(e *osutil.MountEntry) string {
...
// option.
func XSnapdSynthetic(e *osutil.MountEntry) bool {
