...
#include "../libsnap-wrap-private/error.h"
...
/**
 * Opaque structure describing command-line arguments to snap-wrap.
 **/
struct sc_args;

/**
 * Parse command line arguments for snap-wrap.
 *
...
/**
 * Free the object describing command-line arguments to snap-wrap.
 **/
...
/**
 * Check if snap-wrap was invoked with the --version switch.
 **/
bool sc_args_is_version_query(struct sc_args *args);

/**
 * Check if snap-wrap was invoked with the --classic switch.
 **/
bool sc_args_is_classic_confinement(struct sc_args *args);

/**
 * Get the security tag passed to snap-wrap.
 *
 * The return value may be NULL if snap-wrap was invoked with --version. It
...
/**
 * Get the executable name passed to snap-wrap.
 *
 * The return value may be NULL if snap-wrap was invoked with --version. It
 * is never NULL otherwise.
 *
