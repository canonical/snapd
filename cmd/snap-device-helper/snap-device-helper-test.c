...
static void test_sdh_err_funtag5(sdh_test_fixture *fixture, gconstpointer test_data) {
    run_sdh_die("add", "snap_thisisverylonginstancenameabovelengthlimit_instancekey_bar", "8", "4", "block",
                "snap instance of tag "
                "\"snap_thisisverylonginstancenameabovelengthlimit_instancekey_bar\" "
                "is too long\n");
}
