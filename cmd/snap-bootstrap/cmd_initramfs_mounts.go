...
func snapRevisionAssertionFromNameAndRevisionNumber(db *asserts.Database, name string, revision snap.Revision, authority string) (*asserts.SnapRevision, error) {
