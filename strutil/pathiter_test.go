...
func (s *pathIterSuite) TestPathIteratorFilename(c *C) {
	...
	c.Assert(iter.CurrentCleanPath(), Equals, "foo")
...
func (s *pathIterSuite) TestPathIteratorRelative(c *C) {
	...
	c.Assert(iter.CurrentCleanPath(), Equals, "foo/bar")
...
func (s *pathIterSuite) TestPathIteratorAbsoluteAlmostClean(c *C) {
	...
	c.Assert(iter.CurrentCleanPath(), Equals, "/")
...
func (s *pathIterSuite) TestPathIteratorAbsoluteCleanDepth4(c *C) {
	...
	c.Assert(iter.CurrentCleanPath(), Equals, "/foo/bar/baz")
...
func (s *pathIterSuite) TestPathIteratorUnicode(c *C) {
	...
	c.Assert(iter.CurrentCleanPath(), Equals, "/zażółć")
	...
	c.Assert(iter.CurrentCleanPath(), Equals, "/zażółć/gęślą")
	...
	c.Assert(iter.CurrentCleanPath(), Equals, "/zażółć/gęślą/jaźń")
