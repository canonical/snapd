...
var (
	...
	// Errors when snapd is stopping and the prompting system has been closed,
	// so an API request should be retried.
	ErrPromptingClosed = errors.New("prompting system has already been closed")
