...
func (b *Backend) Setup(snapOpts interfaces.SecurityBackendSnapOptions, repo *interfaces.Repository, tm timings.Measurer) error {
	...
	rulesFilePath := snapRulesFilePath(snapOpts.SnapInfo.InstanceName())
	...
	if (snapOpts.ConfinementOpts.DevMode || snapOpts.ConfinementOpts.Classic) && !snapOpts.ConfinementOpts.JailMode {
