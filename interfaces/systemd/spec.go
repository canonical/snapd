...
// AddDropIn records, at a given key, a systemd drop-in snippet with
// provided content for services associated with the given
// interface. The key needs to be unique for a given service.
