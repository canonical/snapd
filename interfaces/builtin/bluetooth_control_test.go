...
func (s *BluetoothControlInterfaceSuite) TestUsedSecuritySystems(c *C) {
	expectedSnippet := `
# This file contains udev rules for managing kernel bluetooth stack
#
# Do not edit this file, it will be overwritten on updates

SUBSYSTEM=="bluetooth", KERNEL=="hci[0-9]*", TAG+="snap_other_app2"
`
	...
	// connected plugs have a non-nil security snippet for bluetooth
