...
func (s *MirInterfaceSuite) TestUDev(c *C) {
	expectedSnippet := `
# This file contains udev rules for mir server.
#
# Do not edit this file, it will be overwritten on updates

KERNEL=="tty",       TAG+="snap_mir-server_mir"
KERNEL=="tty[0-9]*", TAG+="snap_mir-server_mir"

# input devices
KERNEL=="mice",   NAME="input/%k", TAG+="snap_mir-server_mir"
KERNEL=="mouse*", NAME="input/%k", TAG+="snap_mir-server_mir"
KERNEL=="event*", NAME="input/%k", TAG+="snap_mir-server_mir"
KERNEL=="js*",    NAME="input/%k", TAG+="snap_mir-server_mir"
KERNEL=="ts*",    NAME="input/%k", TAG+="snap_mir-server_mir"
`
