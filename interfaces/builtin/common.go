...
// are allowed.
func (iface *commonInterface) BeforePrepareSlot(slot *interfaces.SlotData) error {
...
func (iface *commonInterface) UDevConnectedPlug(spec *udev.Specification, plug *interfaces.PlugData, slot *interfaces.SlotData) error {
