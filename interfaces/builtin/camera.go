...
/sys/devices/pci**/usb*/**/{busnum,devnum,idVendor,idProduct,interface,modalias,speed} r,
/run/udev/data/{c81:[0-9],+usb:}* r, # video4linux (/dev/video*, etc)
/sys/class/video4linux/ r,
/sys/devices/{pci**,platform/**}/usb*/**/video4linux/** r,
`
