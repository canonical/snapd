...
func (s *systemPackagesDocSuite) TestAppArmorSpec(c *C) {
	...
	c.Assert(spec.SnippetForTag("snap.consumer.app"), testutil.Contains, "/usr/share/javascript/**")
	...
	c.Assert(spec.SnippetForTag("snap.consumer.app"), testutil.Contains, "/usr/share/info/{,**} r,")
	...
	c.Check(updateNS, testutil.Contains, "  mount options=(bind) /var/lib/snapd/hostfs/usr/share/javascript/ -> /usr/share/javascript/,\n")
	c.Check(updateNS, testutil.Contains, "  remount options=(bind, ro) /usr/share/javascript/,\n")
	c.Check(updateNS, testutil.Contains, "  umount /usr/share/javascript/,\n")
	...
	c.Check(updateNS, testutil.Contains, "  mount options=(bind) /var/lib/snapd/hostfs/usr/share/info/ -> /usr/share/info/,\n")
	c.Check(updateNS, testutil.Contains, "  remount options=(bind, ro) /usr/share/info/,\n")
	c.Check(updateNS, testutil.Contains, "  umount /usr/share/info/,\n")
	// check mimic bits
	...
	c.Check(updateNS, testutil.Contains, "  \"/usr/share/info/*/\" rw,\n")
	...
	c.Check(updateNS, testutil.Contains, "  \"/tmp/.snap/usr/share/gimp/2.0/*/\" rw,\n")
	c.Check(updateNS, testutil.Contains, "  \"/tmp/.snap/usr/share/javascript/\" rw,\n")
	c.Check(updateNS, testutil.Contains, "  \"/tmp/.snap/usr/share/javascript/*/\" rw,\n")
	...
	c.Check(updateNS, testutil.Contains, "  \"/tmp/.snap/usr/share/help/*/\" rw,\n")
	c.Check(updateNS, testutil.Contains, "  \"/tmp/.snap/usr/share/info/\" rw,\n")
	c.Check(updateNS, testutil.Contains, "  \"/tmp/.snap/usr/share/info/*/\" rw,\n")
