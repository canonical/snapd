...
func (s *systemPackagesDocSuite) TestAppArmorSpec(c *C) {
	...
	c.Assert(spec.SnippetForTag("snap.consumer.app"), testutil.Contains, "/usr/share/javascript/{jquery,jquery-ui,sphinxdoc}/{,**}")
	...
	c.Check(updateNS, testutil.Contains, "  mount options=(bind) /var/lib/snapd/hostfs/usr/share/javascript/jquery-ui/ -> /usr/share/javascript/jquery-ui/,\n")
	c.Check(updateNS, testutil.Contains, "  remount options=(bind, ro) /usr/share/javascript/jquery-ui/,\n")
	c.Check(updateNS, testutil.Contains, "  umount /usr/share/javascript/jquery-ui/,\n")
	...
	c.Check(updateNS, testutil.Contains, "  \"/usr/share/javascript/jquery-ui/*/\" rw,\n")
	...
	c.Check(updateNS, testutil.Contains, "  \"/tmp/.snap/usr/share/javascript/jquery/*/\" rw,\n")
	c.Check(updateNS, testutil.Contains, "  \"/tmp/.snap/usr/share/javascript/jquery-ui/\" rw,\n")
	c.Check(updateNS, testutil.Contains, "  \"/tmp/.snap/usr/share/javascript/jquery-ui/*/\" rw,\n")
...
func (s *systemPackagesDocSuite) TestMountSpec(c *C) {
	...
	c.Check(entries[6].Name, Equals, "/var/lib/snapd/hostfs/usr/share/javascript/jquery-ui")
	c.Check(entries[6].Dir, Equals, "/usr/share/javascript/jquery-ui")
	c.Check(entries[6].Options, DeepEquals, []string{"bind", "ro"})
	c.Check(entries[7].Name, Equals, "/var/lib/snapd/hostfs/usr/share/javascript/sphinxdoc")
	c.Check(entries[7].Dir, Equals, "/usr/share/javascript/sphinxdoc")
	c.Check(entries[7].Options, DeepEquals, []string{"bind", "ro"})
	c.Check(entries[8].Name, Equals, "/var/lib/snapd/hostfs/usr/share/libreoffice/help")
	c.Check(entries[8].Dir, Equals, "/usr/share/libreoffice/help")
	c.Check(entries[8].Options, DeepEquals, []string{"bind", "ro"})
	c.Check(entries[9].Name, Equals, "/var/lib/snapd/hostfs/usr/share/sphinx_rtd_theme")
	c.Check(entries[9].Dir, Equals, "/usr/share/sphinx_rtd_theme")
	c.Check(entries[9].Options, DeepEquals, []string{"bind", "ro"})
	c.Check(entries[10].Name, Equals, "/var/lib/snapd/hostfs/usr/share/xubuntu-docs")
	c.Check(entries[10].Dir, Equals, "/usr/share/xubuntu-docs")
