...
func (s *AllSuite) TestInterfaces(c *C) {
	...
	c.Check(all, DeepContains, builtin.NewIoPortsControlInterface())
	...
	c.Check(all, DeepContains, builtin.NewPhysicalMemoryControlInterface())
	c.Check(all, DeepContains, builtin.NewPhysicalMemoryObserveInterface())
