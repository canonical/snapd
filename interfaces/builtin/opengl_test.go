...
SUBSYSTEM="drm", KERNEL=="card[0-9]*", TAG+="snap_client-snap_app-accessing-opengl"
KERNEL=="nvidia*", TAG+="snap_client-snap_app-accessing-opengl"
KERNEL=="vchiq",   TAG+="snap_client-snap_app-accessing-opengl"
`
