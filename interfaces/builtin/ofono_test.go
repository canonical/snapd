...
func (s *OfonoInterfaceSuite) TestPermanentSlotSnippetUdev(c *C) {
	...
	c.Assert(udevSpec.Snippets()[0], testutil.Contains, `LABEL="ofono_isi_end"`)

	expectedSnippet := `
# This file contains udev rules for ofono service.
#
# Do not edit this file, it will be overwritten on updates

KERNEL=="tty[A-RT-Z]*[0-9]|cdc-wdm[0-9]*", TAG+="snap_ofono_app"
KERNEL=="tun",         TAG+="snap_ofono_app"
KERNEL=="tun[0-9]*",   TAG+="snap_ofono_app"
KERNEL=="dsp",         TAG+="snap_ofono_app"
KERNEL=="ttyLTM[0-9]", TAG+="snap_ofono_app"
KERNEL=="ttyUSB[0-9]", TAG+="snap_ofono_app"
`
	c.Assert(udevSpec.Snippets()[0], testutil.Contains, expectedSnippet)
}
