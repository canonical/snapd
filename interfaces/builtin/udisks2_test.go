...
func (s *UDisks2InterfaceSuite) TestUsedSecuritySystems(c *C) {
	...
	expectedSnippet := `
# This file contains udev rules for UDisks2 service.
#
# Do not edit this file, it will be overwritten on updates

SUBSYSTEM=="block", TAG+="snap_udisks2_app1"
# This tags all USB devices, so we'll use AppArmor to mediate specific access (eg, /dev/sd* and /dev/mmcblk*)
SUBSYSTEM=="usb", TAG+="snap_udisks2_app1"
`
	...
	c.Check(udevSpec.Snippets()[0], testutil.Contains, expectedSnippet)
