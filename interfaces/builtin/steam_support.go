...
mount options=(rw, rbind) /oldroot/opt/**/steamapps/common/**/opt/ -> /newroot/opt/,
mount options=(rw, rbind) /oldroot/srv/**/steamapps/common/**/srv/ -> /newroot/srv/,
mount options=(rw, rbind) /oldroot/media/**/steamapps/common/**/usr/etc/** -> /newroot/etc/**,
mount options=(rw, rbind) /oldroot/mnt/**/steamapps/common/**/usr/etc/** -> /newroot/etc/**,
mount options=(rw, rbind) /oldroot/run/media/**/steamapps/common/**/usr/etc/** -> /newroot/etc/**,
