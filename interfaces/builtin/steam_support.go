...
// From 60-steam-input.rules
var steamSupportSteamInputUDevRules = []string{
	// Valve USB devices
...
// From 60-steam-vr.rules
var steamSupportSteamVRUDevRules = []string{
...
// Potential issue: these need to be loaded before `/lib/udev/rules.d/73-seat-late.rules`, can we ensure this?
var steamSupportConnectedPlugUDev = append(steamSupportSteamInputUDevRules, steamSupportSteamVRUDevRules...)
...
func init() {
	registerIface(&commonInterface{
		...
		connectedPlugUDev:     steamSupportConnectedPlugUDev,
	})
}
