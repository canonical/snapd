...
const gsettingsMockSlotSnapInfoYaml = `name: core
version: 1.0
type: os
slots:
 gsettings:
...
func (s *GsettingsInterfaceSuite) SetUpTest(c *C) {
	s.slot, s.slotInfo = MockConnectedSlot(c, gsettingsMockSlotSnapInfoYaml, nil, "gsettings")
	s.plug, s.plugInfo = MockConnectedPlug(c, gsettingsMockPlugSnapInfoYaml, nil, "gsettings")
}
