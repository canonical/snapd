...
const netbindMockSlotSnapInfoYaml = `name: core
version: 1.0
type: os
slots:
 network-bind:
...
func (s *NetworkBindInterfaceSuite) SetUpTest(c *C) {
	s.slot, s.slotInfo = MockConnectedSlot(c, netbindMockSlotSnapInfoYaml, nil, "network-bind")
	s.plug, s.plugInfo = MockConnectedPlug(c, netbindMockPlugSnapInfoYaml, nil, "network-bind")
}
