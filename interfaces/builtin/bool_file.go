...
func (iface *BoolFileInterface) SlotSecuritySnippet(slot *interfaces.Slot, plug *interfaces.Plug, securitySystem interfaces.SecuritySystem) ([]byte, error) {
	gpioSnippet := []byte(`
...
func (iface *BoolFileInterface) PlugSecuritySnippet(slot *interfaces.Slot, plug *interfaces.Plug, securitySystem interfaces.SecuritySystem) ([]byte, error) {
	switch securitySystem {
	case interfaces.SecurityAppArmor:
