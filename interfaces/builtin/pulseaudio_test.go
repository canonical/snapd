...
func (s *PulseAudioInterfaceSuite) TestUDev(c *C) {
	expectedSnippet := `
# This file contains udev rules for pulseaudio service.
#
# Do not edit this file, it will be overwritten on updates
KERNEL=="pcm[CD0-9cp]*",  NAME="snd/%k", TAG+="snap_pulseaudio_app1"
KERNEL=="controlC[0-9]*", NAME="snd/%k", TAG+="snap_pulseaudio_app1"
KERNEL=="timer",          NAME="snd/%k", TAG+="snap_pulseaudio_app1"
`
	udevSpec := &udev.Specification{}
	err := udevSpec.AddPermanentSlot(s.iface, s.coreSlot)
	c.Assert(err, IsNil)
