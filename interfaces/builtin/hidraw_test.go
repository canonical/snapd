...
SUBSYSTEM=="hidraw", SUBSYSTEMS=="usb", ATTRS{idVendor}=="0001", ATTRS{idProduct}=="0001", SYMLINK+="hidraw-canbus" # hidraw`
...
SUBSYSTEM=="hidraw", SUBSYSTEMS=="usb", ATTRS{idVendor}=="ffff", ATTRS{idProduct}=="ffff", SYMLINK+="hidraw-mydevice" # hidraw`
	spec = &udev.Specification{}
...
func (s *HidrawInterfaceSuite) TestConnectedPlugUDevSnippets(c *C) {
	...
	c.Assert(spec.Snippets(), HasLen, 1)
	snippet := spec.Snippets()[0]
	expectedSnippet1 := `SUBSYSTEM=="hidraw", KERNEL=="hidraw0", TAG+="snap_client-snap_app-accessing-2-devices" # hidraw`
	c.Assert(snippet, Equals, expectedSnippet1)
	...
	snippet = spec.Snippets()[0]
	expectedSnippet2 := `IMPORT{builtin}="usb_id"
SUBSYSTEM=="hidraw", SUBSYSTEMS=="usb", ATTRS{idVendor}=="0001", ATTRS{idProduct}=="0001", TAG+="snap_client-snap_app-accessing-2-devices" # hidraw`
	c.Assert(snippet, Equals, expectedSnippet2)
...
SUBSYSTEM=="hidraw", SUBSYSTEMS=="usb", ATTRS{idVendor}=="ffff", ATTRS{idProduct}=="ffff", TAG+="snap_client-snap_app-accessing-2-devices" # hidraw`
