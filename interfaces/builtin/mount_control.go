...
var allowedFilesystemSpecificMountOptions = map[string][]string{
	...
	"nfs":        {"nfsvers", "vers", "soft", "hard", "softreval", "nosoftreval", "intr", "nointr", "timeo", "retrans", "rsize", "wsize", "ac", "noac", "acregmin", "acregmax", "acdirmin", "acdirmax", "bg", "fg", "nconnect", "max_connect", "rdirplus", "nordirplus", "retry", "sec", "sharecache", "nosharecache", "revsport", "norevsport", "lookupcache", "fsc", "nofsc", "sloppy", "proto", "udp", "tcp", "rdma", "port", "mountport", "mountproto", "mounthost", "mountvers", "namlen", "lock", "nolock", "cto", "nocto", "acl", "noacl", "local_lock", "minorversion", "clientaddr", "migration", "nomigration"},
	"nfs4":       {"nfsvers", "vers", "soft", "hard", "softreval", "nosoftreval", "intr", "nointr", "timeo", "retrans", "rsize", "wsize", "ac", "noac", "acregmin", "acregmax", "acdirmin", "acdirmax", "bg", "fg", "nconnect", "max_connect", "rdirplus", "nordirplus", "retry", "sec", "sharecache", "nosharecache", "revsport", "norevsport", "lookupcache", "fsc", "nofsc", "sloppy", "proto", "minorversion", "port", "cto", "nocto", "clientaddr", "migration", "nomigration"},
	"ntfs":       {"iocharset", "nls", "utf8", "uni_xlate", "posix", "uid", "gid", "umask"},
	"ntfs-3g":    {"acl", "allow_other", "big_writes", "compression", "debug", "delay_mtime", "dmask", "efs_raw", "fmask", "force", "hide_dot_files", "hide_hid_files", "inherit", "locale", "max_read", "no_def_opts", "no_detach", "nocompression", "norecover", "permissions", "posix_nlink", "recover", "remove_hiberfile", "show_sys_files", "silent", "special_files", "streams_interface", "uid", "gid", "umask", "usermapping", "user_xattr", "windows_names"},
	"lowntfs-3g": {"acl", "allow_other", "big_writes", "compression", "debug", "delay_mtime", "dmask", "efs_raw", "fmask", "force", "hide_dot_files", "hide_hid_files", "ignore_case", "inherit", "locale", "max_read", "no_def_opts", "no_detach", "nocompression", "norecover", "permissions", "posix_nlink", "recover", "remove_hiberfile", "show_sys_files", "silent", "special_files", "streams_interface", "uid", "gid", "umask", "usermapping", "user_xattr", "windows_names"},
	"overlay":    {"lowerdir", "upperdir", "workdir", "userxattr", "redirect_dir", "index", "uuid", "nfs_export", "xino", "metacopy", "volatile"}, // overlayfs not allowed
	"ramfs":      {},
