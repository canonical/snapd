...
`
	...
	c.Assert(spec.SnippetForTag("snap.consumer.app"), Equals, expectedSnippet)
}
...
KERNEL=="linux-user-bde",   TAG+="snap_consumer_app"
KERNEL=="linux-kernel-bde", TAG+="snap_consumer_app"
KERNEL=="linux-bcm-knet",   TAG+="snap_consumer_app"
`
	spec := &udev.Specification{}
	c.Assert(spec.AddConnectedPlug(s.iface, s.plug, nil, s.slot, nil), IsNil)
	c.Assert(len(spec.Snippets()), Equals, 1)
	c.Assert(spec.Snippets()[0], Equals, expectedSnippet)
}
