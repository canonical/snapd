...
KERNEL=="controlC[0-9]*",        TAG+="snap_other_app"
KERNEL=="hwC[0-9]*D[0-9]*",      TAG+="snap_other_app"
KERNEL=="pcmC[0-9]*D[0-9]*[cp]", TAG+="snap_other_app"
KERNEL=="midiC[0-9]*D[0-9]*",    TAG+="snap_other_app"
KERNEL=="timer",                 TAG+="snap_other_app"
KERNEL=="seq",                   TAG+="snap_other_app"
SUBSYSTEM=="sound", KERNEL=="card[0-9]*", TAG+="snap_other_app"
`
