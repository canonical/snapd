...
var defaultCoreRuntimeTemplateRules = `
  ...
  /{,usr/}bin/arch ixr,
  /usr/lib/cargo/bin/coreutils/arch ixr,
  /{,usr/}bin/{,g,m}awk ixr,
  /{,usr/}bin/base32 ixr,
  /usr/lib/cargo/bin/coreutils/base32 ixr,
  /{,usr/}bin/base64 ixr,
  /usr/lib/cargo/bin/coreutils/base64 ixr,
  /{,usr/}bin/basename ixr,
  /usr/lib/cargo/bin/coreutils/basename ixr,
  /{,usr/}bin/bunzip2 ixr,
  /{,usr/}bin/busctl ixr,
  /{,usr/}bin/bzcat ixr,
  /{,usr/}bin/bzdiff ixr,
  ...
  /{,usr/}bin/bzip2 ixr,
  /{,usr/}bin/cat ixr,
  /usr/lib/cargo/bin/coreutils/cat ixr,
  /{,usr/}bin/chgrp ixr,
  /usr/lib/cargo/bin/coreutils/chgrp ixr,
  /{,usr/}bin/chmod ixr,
  /usr/lib/cargo/bin/coreutils/chmod ixr,
  /{,usr/}bin/chown ixr,
  /usr/lib/cargo/bin/coreutils/chown ixr,
  /{,usr/}bin/clear ixr,
  /{,usr/}bin/cmp ixr,
  /{,usr/}bin/cp ixr,
  /usr/lib/cargo/bin/coreutils/cp ixr,
  /{,usr/}bin/cpio ixr,
  /{,usr/}bin/cut ixr,
  /usr/lib/cargo/bin/coreutils/cut ixr,
  /{,usr/}bin/date ixr,
  /usr/lib/cargo/bin/coreutils/date ixr,
  /{,usr/}bin/dbus-daemon ixr,
  /{,usr/}bin/dbus-run-session ixr,
  /{,usr/}bin/dbus-send ixr,
  /{,usr/}bin/dd ixr,
  /usr/lib/cargo/bin/coreutils/dd ixr,
  /{,usr/}bin/diff{,3} ixr,
  /{,usr/}bin/dir ixr,
  /usr/lib/cargo/bin/coreutils/dir ixr,
  /{,usr/}bin/dirname ixr,
  /usr/lib/cargo/bin/coreutils/dirname ixr,
  /{,usr/}bin/du ixr,
  /usr/lib/cargo/bin/coreutils/du ixr,
  /{,usr/}bin/echo ixr,
  /usr/lib/cargo/bin/coreutils/echo ixr,
  /{,usr/}bin/{,e,f,r}grep ixr,
  /{,usr/}bin/env ixr,
  /usr/lib/cargo/bin/coreutils/env ixr,
  /{,usr/}bin/expr ixr,
  /{,usr/}bin/false ixr,
  /usr/lib/cargo/bin/coreutils/false ixr,
  /{,usr/}bin/find ixr,
  /{,usr/}bin/flock ixr,
  /{,usr/}bin/fmt ixr,
  /usr/lib/cargo/bin/coreutils/fmt ixr,
  /{,usr/}bin/fold ixr,
  /usr/lib/cargo/bin/coreutils/fold ixr,
  /{,usr/}bin/free ixr,
  /{,usr/}bin/getconf ixr,
  /{,usr/}bin/getent ixr,
  /{,usr/}bin/getopt ixr,
  /{,usr/}bin/groups ixr,
  /usr/lib/cargo/bin/coreutils/groups ixr,
  /{,usr/}bin/gzip ixr,
  /{,usr/}bin/head ixr,
  /usr/lib/cargo/bin/coreutils/head ixr,
  /{,usr/}bin/hostname ixr,
  /{,usr/}bin/id ixr,
  /usr/lib/cargo/bin/coreutils/id ixr,
  /{,usr/}bin/igawk ixr,
  /{,usr/}bin/infocmp ixr,
  /{,usr/}bin/kill ixr,
  /{,usr/}bin/ldd ixr,
  ...
  /{,usr/}bin/line ixr,
  /{,usr/}bin/link ixr,
  /usr/lib/cargo/bin/coreutils/link ixr,
  /{,usr/}bin/ln ixr,
  /usr/lib/cargo/bin/coreutils/ln ixr,
  /{,usr/}bin/locale ixr,
  /{,usr/}bin/logger ixr,
  /{,usr/}bin/ls ixr,
  /usr/lib/cargo/bin/coreutils/ls ixr,
  /{,usr/}bin/md5sum ixr,
  /usr/lib/cargo/bin/coreutils/md5sum ixr,
  /{,usr/}bin/mkdir ixr,
  /usr/lib/cargo/bin/coreutils/mkdir ixr,
  /{,usr/}bin/mkfifo ixr,
  /usr/lib/cargo/bin/coreutils/mkfifo ixr,
  /{,usr/}bin/mknod ixr,
  /usr/lib/cargo/bin/coreutils/mknod ixr,
  /{,usr/}bin/mktemp ixr,
  /usr/lib/cargo/bin/coreutils/mktemp ixr,
  /{,usr/}bin/more ixr,
  /{,usr/}bin/mv ixr,
  /usr/lib/cargo/bin/coreutils/mv ixr,
  /{,usr/}bin/nice ixr,
  /usr/lib/cargo/bin/coreutils/nice ixr,
  /{,usr/}bin/nohup ixr,
  /usr/lib/cargo/bin/coreutils/nohup ixr,
  /{,usr/}bin/numfmt ixr,
  /{,usr/}bin/od ixr,
  /usr/lib/cargo/bin/coreutils/od ixr,
  /{,usr/}bin/openssl ixr, # may cause harmless capability block_suspend denial
  /{,usr/}bin/paste ixr,
  /usr/lib/cargo/bin/coreutils/paste ixr,
  /{,usr/}bin/pgrep ixr,
  /{,usr/}bin/printenv ixr,
  /usr/lib/cargo/bin/coreutils/printenv ixr,
  /{,usr/}bin/printf ixr,
  /usr/lib/cargo/bin/coreutils/printf ixr,
  /{,usr/}bin/ps ixr,
  /{,usr/}bin/pwd ixr,
  /usr/lib/cargo/bin/coreutils/pwd ixr,
  /{,usr/}bin/readlink ixr,
  /usr/lib/cargo/bin/coreutils/readlink ixr,
  /{,usr/}bin/realpath ixr,
  /usr/lib/cargo/bin/coreutils/realpath ixr,
  /{,usr/}bin/rev ixr,
  /{,usr/}bin/rm ixr,
  /usr/lib/cargo/bin/coreutils/rm ixr,
  /{,usr/}bin/rmdir ixr,
  /usr/lib/cargo/bin/coreutils/rmdir ixr,
  /{,usr/}bin/run-parts ixr,
  /{,usr/}bin/sed ixr,
  /{,usr/}bin/seq ixr,
  /usr/lib/cargo/bin/coreutils/seq ixr,
  /{,usr/}bin/setpriv ixr,
  /{,usr/}bin/sha{1,224,256,384,512}sum ixr,
  /usr/lib/cargo/bin/coreutils/sha{1,224,256,384,512}sum ixr,
  /{,usr/}bin/shuf ixr,
  /usr/lib/cargo/bin/coreutils/shuf ixr,
  /{,usr/}bin/sleep ixr,
  /usr/lib/cargo/bin/coreutils/sleep ixr,
  /{,usr/}bin/sort ixr,
  /usr/lib/cargo/bin/coreutils/sort ixr,
  /{,usr/}bin/stat ixr,
  /usr/lib/cargo/bin/coreutils/stat ixr,
  /{,usr/}bin/stdbuf ixr,
  /usr/lib/cargo/bin/coreutils/stdbuf ixr,
  /{,usr/}bin/stty ixr,
  /usr/lib/cargo/bin/coreutils/stty ixr,
  /{,usr/}bin/sync ixr,
  /usr/lib/cargo/bin/coreutils/sync ixr,
  /{,usr/}bin/systemd-cat ixr,
  /{,usr/}bin/systemd-creds ixr,
  /{,usr/}bin/tac ixr,
  /usr/lib/cargo/bin/coreutils/tac ixr,
  /{,usr/}bin/tail ixr,
  /usr/lib/cargo/bin/coreutils/tail ixr,
  /{,usr/}bin/tar ixr,
  /{,usr/}bin/tee ixr,
  /usr/lib/cargo/bin/coreutils/tee ixr,
  /{,usr/}bin/test ixr,
  /usr/lib/cargo/bin/coreutils/test ixr,
  /{,usr/}bin/tempfile ixr,
  /{,usr/}bin/tset ixr,
  /{,usr/}bin/touch ixr,
  /usr/lib/cargo/bin/coreutils/touch ixr,
  /{,usr/}bin/tput ixr,
  /{,usr/}bin/tr ixr,
  /usr/lib/cargo/bin/coreutils/tr ixr,
  /{,usr/}bin/true ixr,
  /usr/lib/cargo/bin/coreutils/true ixr,
  /{,usr/}bin/tty ixr,
  /usr/lib/cargo/bin/coreutils/tty ixr,
  /{,usr/}bin/uname ixr,
  /usr/lib/cargo/bin/coreutils/uname ixr,
  /{,usr/}bin/uniq ixr,
  /usr/lib/cargo/bin/coreutils/uniq ixr,
  /{,usr/}bin/unlink ixr,
  /usr/lib/cargo/bin/coreutils/unlink ixr,
  /{,usr/}bin/unxz ixr,
  /{,usr/}bin/unzip ixr,
  /{,usr/}bin/uptime ixr,
  /{,usr/}bin/vdir ixr,
  /usr/lib/cargo/bin/coreutils/vdir ixr,
  /{,usr/}bin/vim.tiny ixr,
  /{,usr/}bin/wc ixr,
  /usr/lib/cargo/bin/coreutils/wc ixr,
  /{,usr/}bin/which{,.debianutils} ixr,
  /{,usr/}bin/xargs ixr,
  /{,usr/}bin/xz ixr,
  /{,usr/}bin/yes ixr,
  /usr/lib/cargo/bin/coreutils/yes ixr,
  /{,usr/}bin/zcat ixr,
