...
func (ms *deviceMgmtState) getRequestMessage(id string) (*handlers.RequestMessage, error) {
...
func (m *DeviceMgmtManager) getMessageAndState(msgID string) (*deviceMgmtState, *handlers.RequestMessage, error) {
	ms, err := m.getState()
	if err != nil {
		return nil, nil, err
	}
