...
func (s *uc20RemodelLogicSuite) SetUpTest(c *C) {
	...
	restore := boot.MockResealKeyToModeenv(func(_ string, m *boot.Modeenv, expectReseal bool, _ boot.Unlocker, revokeOldKeys bool) error {
...
func (s *uc20RemodelLogicSuite) TestReregRemodelContextUC20(c *C) {
	...
	resealKeysCalls := 0
	restore := boot.MockResealKeyToModeenv(func(_ string, m *boot.Modeenv, expectReseal bool, u boot.Unlocker, revokeOldKeys bool) error {
		resealKeysCalls++
