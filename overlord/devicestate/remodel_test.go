...
func (s *uc20RemodelLogicSuite) SetUpTest(c *C) {
	...
	restore := boot.MockResealKeyToModeenv(func(_ string, m *boot.Modeenv, opts boot.ResealKeyToModeenvOptions, _ boot.Unlocker, revokeOldKeys bool) error {
...
func (s *uc20RemodelLogicSuite) TestReregRemodelContextUC20(c *C) {
	...
	resealKeysCalls := 0
	restore := boot.MockResealKeyToModeenv(func(_ string, m *boot.Modeenv, opts boot.ResealKeyToModeenvOptions, u boot.Unlocker, revokeOldKeys bool) error {
		resealKeysCalls++
