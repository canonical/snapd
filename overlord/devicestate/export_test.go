...
func MockFdestateLastResealBootID(bootID string) (restore func()) {
	return testutil.Mock(&fdestateLastResealBootID, func(st *state.State) (string, error) { return bootID, nil })
}
