...
func (m *DeviceManager) LoadLabelInformation(wantedSystemLabel string) (*System, *gadget.Info, map[snap.Type]*snap.Info, map[snap.Type]*seed.Snap, *EncryptionSupportInfo, error) {
