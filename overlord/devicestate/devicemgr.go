...
func Manager(s *state.State, hookManager *hookstate.HookManager, runner *runner.TaskRunner, newStore func(storecontext.DeviceBackend) snapstate.StoreService) (*DeviceManager, error) {
	delayedCrossMgrInit()
