...
func (s *createSystemSuite) TestCreateSystemLTSRedirectUpdatesSnapdSeedChannel(c *C) {
	s.testCreateSystemSnapdSeedChannel(c, "18/stable", "18/stable")
}

func (s *createSystemSuite) TestCreateSystemWithoutLTSRedirectKeepsModelSnapdChannel(c *C) {
