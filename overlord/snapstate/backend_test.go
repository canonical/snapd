...
func (f *fakeSnappyBackend) StopServices(svcs []*snap.AppInfo, _ map[string]*snap.AppInfo, reason snap.ServiceStopReason, meter progress.Meter, tm timings.Measurer) error {
