...
// TryEnforceValidationSets is hooked from assertstate
var TryEnforceValidationSets func(*state.State, []string, int, []*snapasserts.InstalledSnap, map[string]bool) error
