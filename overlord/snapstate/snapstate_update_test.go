...
subgraph "cluster[1 2]" {
  "[10] core18:setup-profiles"
  "[11] core18:link-snap"
  "[12] core18:auto-connect"
  "[13] core18:set-auto-aliases"
  "[14] core18:setup-aliases"
  "[15] core18:run-hook{post-refresh}"
  "[16] core18:start-snap-services"
  "[17] core18:cleanup"
  "[18] core18:run-hook{check-health}"
  "[19] gadget:prerequisites"
  "[1] core18:prerequisites"
  "[20] gadget:download-snap"
  "[21] gadget:validate-snap"
  "[22] gadget:mount-snap"
  "[23] gadget:run-hook{pre-refresh}"
  "[24] gadget:stop-snap-services"
  "[25] gadget:remove-aliases"
  "[26] gadget:unlink-current-snap"
  "[27] gadget:update-gadget-assets"
  "[28] gadget:update-gadget-cmdline"
  "[29] gadget:copy-snap-data"
  "[2] core18:download-snap"
  "[30] gadget:setup-profiles"
  "[31] gadget:link-snap"
  "[32] gadget:auto-connect"
  "[33] gadget:set-auto-aliases"
  "[34] gadget:setup-aliases"
  "[35] gadget:run-hook{post-refresh}"
  "[36] gadget:start-snap-services"
  "[37] gadget:cleanup"
  "[38] gadget:run-hook{configure}"
  "[39] gadget:run-hook{check-health}"
  "[3] core18:validate-snap"
  "[4] core18:mount-snap"
  "[5] core18:run-hook{pre-refresh}"
  "[6] core18:stop-snap-services"
  "[7] core18:remove-aliases"
  "[8] core18:unlink-current-snap"
  "[9] core18:copy-snap-data"
}
"[10] core18:setup-profiles" -> "[11] core18:link-snap"
"[10] core18:setup-profiles" -> "[18] core18:run-hook{check-health}"
"[11] core18:link-snap" -> "[12] core18:auto-connect"
"[11] core18:link-snap" -> "[18] core18:run-hook{check-health}"
"[11] core18:link-snap" -> "[19] gadget:prerequisites"
"[12] core18:auto-connect" -> "[13] core18:set-auto-aliases"
"[12] core18:auto-connect" -> "[18] core18:run-hook{check-health}"
"[13] core18:set-auto-aliases" -> "[14] core18:setup-aliases"
"[13] core18:set-auto-aliases" -> "[18] core18:run-hook{check-health}"
"[14] core18:setup-aliases" -> "[15] core18:run-hook{post-refresh}"
"[14] core18:setup-aliases" -> "[18] core18:run-hook{check-health}"
"[15] core18:run-hook{post-refresh}" -> "[16] core18:start-snap-services"
"[15] core18:run-hook{post-refresh}" -> "[18] core18:run-hook{check-health}"
"[16] core18:start-snap-services" -> "[17] core18:cleanup"
"[16] core18:start-snap-services" -> "[18] core18:run-hook{check-health}"
"[17] core18:cleanup" -> "[18] core18:run-hook{check-health}"
"[18] core18:run-hook{check-health}" -> "[32] gadget:auto-connect"
"[19] gadget:prerequisites" -> "[20] gadget:download-snap"
"[19] gadget:prerequisites" -> "[38] gadget:run-hook{configure}"
"[19] gadget:prerequisites" -> "[39] gadget:run-hook{check-health}"
"[1] core18:prerequisites" -> "[18] core18:run-hook{check-health}"
"[1] core18:prerequisites" -> "[2] core18:download-snap"
"[20] gadget:download-snap" -> "[21] gadget:validate-snap"
"[20] gadget:download-snap" -> "[38] gadget:run-hook{configure}"
"[20] gadget:download-snap" -> "[39] gadget:run-hook{check-health}"
"[21] gadget:validate-snap" -> "[22] gadget:mount-snap"
"[21] gadget:validate-snap" -> "[38] gadget:run-hook{configure}"
"[21] gadget:validate-snap" -> "[39] gadget:run-hook{check-health}"
"[22] gadget:mount-snap" -> "[23] gadget:run-hook{pre-refresh}"
"[22] gadget:mount-snap" -> "[38] gadget:run-hook{configure}"
"[22] gadget:mount-snap" -> "[39] gadget:run-hook{check-health}"
"[23] gadget:run-hook{pre-refresh}" -> "[24] gadget:stop-snap-services"
"[23] gadget:run-hook{pre-refresh}" -> "[38] gadget:run-hook{configure}"
"[23] gadget:run-hook{pre-refresh}" -> "[39] gadget:run-hook{check-health}"
"[24] gadget:stop-snap-services" -> "[25] gadget:remove-aliases"
"[24] gadget:stop-snap-services" -> "[38] gadget:run-hook{configure}"
"[24] gadget:stop-snap-services" -> "[39] gadget:run-hook{check-health}"
"[25] gadget:remove-aliases" -> "[26] gadget:unlink-current-snap"
"[25] gadget:remove-aliases" -> "[38] gadget:run-hook{configure}"
"[25] gadget:remove-aliases" -> "[39] gadget:run-hook{check-health}"
"[26] gadget:unlink-current-snap" -> "[27] gadget:update-gadget-assets"
"[26] gadget:unlink-current-snap" -> "[38] gadget:run-hook{configure}"
"[26] gadget:unlink-current-snap" -> "[39] gadget:run-hook{check-health}"
"[27] gadget:update-gadget-assets" -> "[28] gadget:update-gadget-cmdline"
"[27] gadget:update-gadget-assets" -> "[38] gadget:run-hook{configure}"
"[27] gadget:update-gadget-assets" -> "[39] gadget:run-hook{check-health}"
"[28] gadget:update-gadget-cmdline" -> "[29] gadget:copy-snap-data"
"[28] gadget:update-gadget-cmdline" -> "[38] gadget:run-hook{configure}"
"[28] gadget:update-gadget-cmdline" -> "[39] gadget:run-hook{check-health}"
"[29] gadget:copy-snap-data" -> "[30] gadget:setup-profiles"
"[29] gadget:copy-snap-data" -> "[38] gadget:run-hook{configure}"
"[29] gadget:copy-snap-data" -> "[39] gadget:run-hook{check-health}"
"[2] core18:download-snap" -> "[18] core18:run-hook{check-health}"
"[2] core18:download-snap" -> "[3] core18:validate-snap"
"[30] gadget:setup-profiles" -> "[31] gadget:link-snap"
"[30] gadget:setup-profiles" -> "[38] gadget:run-hook{configure}"
"[30] gadget:setup-profiles" -> "[39] gadget:run-hook{check-health}"
"[31] gadget:link-snap" -> "[12] core18:auto-connect"
"[31] gadget:link-snap" -> "[32] gadget:auto-connect"
"[31] gadget:link-snap" -> "[38] gadget:run-hook{configure}"
"[31] gadget:link-snap" -> "[39] gadget:run-hook{check-health}"
"[32] gadget:auto-connect" -> "[33] gadget:set-auto-aliases"
"[32] gadget:auto-connect" -> "[38] gadget:run-hook{configure}"
"[32] gadget:auto-connect" -> "[39] gadget:run-hook{check-health}"
"[33] gadget:set-auto-aliases" -> "[34] gadget:setup-aliases"
"[33] gadget:set-auto-aliases" -> "[38] gadget:run-hook{configure}"
"[33] gadget:set-auto-aliases" -> "[39] gadget:run-hook{check-health}"
"[34] gadget:setup-aliases" -> "[35] gadget:run-hook{post-refresh}"
"[34] gadget:setup-aliases" -> "[38] gadget:run-hook{configure}"
"[34] gadget:setup-aliases" -> "[39] gadget:run-hook{check-health}"
"[35] gadget:run-hook{post-refresh}" -> "[36] gadget:start-snap-services"
"[35] gadget:run-hook{post-refresh}" -> "[38] gadget:run-hook{configure}"
"[35] gadget:run-hook{post-refresh}" -> "[39] gadget:run-hook{check-health}"
"[36] gadget:start-snap-services" -> "[37] gadget:cleanup"
"[36] gadget:start-snap-services" -> "[38] gadget:run-hook{configure}"
"[36] gadget:start-snap-services" -> "[39] gadget:run-hook{check-health}"
"[37] gadget:cleanup" -> "[38] gadget:run-hook{configure}"
"[37] gadget:cleanup" -> "[39] gadget:run-hook{check-health}"
"[38] gadget:run-hook{configure}" -> "[39] gadget:run-hook{check-health}"
"[3] core18:validate-snap" -> "[18] core18:run-hook{check-health}"
"[3] core18:validate-snap" -> "[4] core18:mount-snap"
"[4] core18:mount-snap" -> "[18] core18:run-hook{check-health}"
"[4] core18:mount-snap" -> "[5] core18:run-hook{pre-refresh}"
"[5] core18:run-hook{pre-refresh}" -> "[18] core18:run-hook{check-health}"
"[5] core18:run-hook{pre-refresh}" -> "[6] core18:stop-snap-services"
"[6] core18:stop-snap-services" -> "[18] core18:run-hook{check-health}"
"[6] core18:stop-snap-services" -> "[7] core18:remove-aliases"
"[7] core18:remove-aliases" -> "[18] core18:run-hook{check-health}"
"[7] core18:remove-aliases" -> "[8] core18:unlink-current-snap"
"[8] core18:unlink-current-snap" -> "[18] core18:run-hook{check-health}"
"[8] core18:unlink-current-snap" -> "[9] core18:copy-snap-data"
"[9] core18:copy-snap-data" -> "[10] core18:setup-profiles"
"[9] core18:copy-snap-data" -> "[18] core18:run-hook{check-health}"
`), Commentf("%v", g))
