...
//
// LTSRedirected is set so later consumers (recovery-system creation) can
// tell Channel was rewritten by LTS policy rather than planned that way.
