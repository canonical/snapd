...
type managerBackend interface {
	...
	UndoSetupComponent(cref naming.ComponentRef, compRev snap.Revision, mountDir string, installRecord *backend.InstallRecord, dev snap.Device, meter progress.Meter) error
