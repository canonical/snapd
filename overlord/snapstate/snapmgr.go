...
// that is being setup. Unless the snap was downloaded to a custom location,
// this will be under dirs.SnapBlobDir.
...
// BlobPath returns the path to the component/squashfs file that is backs the
