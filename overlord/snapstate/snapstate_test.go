...
func (s *canRemoveSuite) TestKernelBootInUseIsKept(c *C) {
	...
	s.bl.SetBootKernel(fmt.Sprintf("%s_%s.snap", kernel.RealName, kernel.SideInfo.Revision))
...
func (s *canRemoveSuite) TestOstInUseIsKept(c *C) {
	...
	s.bl.SetBootBase(fmt.Sprintf("%s_%s.snap", base.RealName, base.SideInfo.Revision))
