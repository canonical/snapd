...
func getVisibilitiesToPrune(userID Access) []Visibility {
...
// have been applied to any matching filter in the storage path. The user
...
func (v *View) Get(databag Databag, request string, constraints map[string]any, user Access) (any, error) {
	...
	visibilities := getVisibilitiesToPrune(user)
