...
func (s *ValidateSuite) TestServiceWhitelistIllegal(c *C) {
...
func (s *ValidateSuite) TestVerifyAppDaemonValue(c *C) {
...
func (s *ValidateSuite) TestServiceWhitelistError(c *C) {
