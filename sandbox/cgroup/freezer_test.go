...
func (s *freezerV2Suite) TestFreezeSnapProcessesV2OtherGroups(c *C) {
	...
	mylog.
		...
		// proper mocking
		Check(cgroup.FreezeSnapProcesses("foo"))
...
func (s *freezerV2Suite) TestFreezeThawSnapProcessesV2ErrWalking(c *C) {
	...
	mylog.
		...
		Check(cgroup.ThawSnapProcesses("foo"))
	...
	mylog.Check(cgroup.FreezeSnapProcesses("foo"))
...
func (s *freezerV2Suite) TestFreezeThawSnapProcessesV2ErrNotFound(c *C) {
	...
	mylog.Check(cgroup.ThawSnapProcesses("foo"))
...
func (s *freezerV2Suite) TestApplyToSnapCallbacks(c *C) {
	...
	var visited []string
	mylog.Check(cgroup.ApplyToSnap("foo",
		func(p string) error {
	...
	mylog.Check(cgroup.ApplyToSnap("foo", maybeFail, maybeSkip))
