...
func (*featureSuite) TestName(c *C) {
	...
	c.Check(features.HiddenSnapDataDir.String(), Equals, "hidden-snap-folder")
...
func (*featureSuite) TestIsExported(c *C) {
	...
	c.Check(features.HiddenSnapDataDir.IsExported(), Equals, true)
...
func (*featureSuite) TestIsEnabledWhenUnset(c *C) {
	...
	c.Check(features.HiddenSnapDataDir.IsEnabledWhenUnset(), Equals, false)
...
func (*featureSuite) TestControlFile(c *C) {
	...
	c.Check(features.HiddenSnapDataDir.ControlFile(), Equals, "/var/lib/snapd/features/hidden-snap-folder")
