...
func (*featureSuite) TestName(c *C) {
	...
	c.Check(features.MoveHomeDir.String(), Equals, "move-home-dir")
...
func (*featureSuite) TestIsExported(c *C) {
	...
	c.Check(features.MoveHomeDir.IsExported(), Equals, true)
...
func (*featureSuite) TestIsEnabledWhenUnset(c *C) {
	...
	c.Check(features.MoveHomeDir.IsEnabledWhenUnset(), Equals, false)
...
func (*featureSuite) TestControlFile(c *C) {
	...
	c.Check(features.MoveHomeDir.ControlFile(), Equals, "/var/lib/snapd/features/move-home-dir")
