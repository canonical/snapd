...
// Plug represents the potential of a given snap to connect to a given slot.
type Plug struct {
	Snap        string                 `json:"snap"`
...
// Interfaces contains information about all slots, plugs and their connections
...
// Interfaces returns all slots, plugs and their connections.
...
func (client *Client) Connect(slotSnapName, slotName, plugSnapName, plugName string) error {
...
// Disconnect breaks the connection between a slot and a plug.
func (client *Client) Disconnect(slotSnapName, slotName, plugSnapName, plugName string) error {
	return client.performInterfaceAction(&InterfaceAction{
		Action: "disconnect",
		Slot: &Slot{
			Snap: slotSnapName,
...
// AddSlot adds a slot to the interface system.
...
// RemoveSlot removes a slot from the interface system.
...
// AddPlug adds a plug to the system.
...
// RemovePlug removes a plug from the system.
