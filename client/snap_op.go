...
func (client *Client) SnapshotMany(names []string, users []string) (changeID string, err error) {
	return client.doMultiSnapAction("snapshot", names, &SnapOptions{Users: users})
}
