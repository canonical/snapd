...
//   - Zic64b
// This extension is defined by the "RVA23 Profiles" specification and not by the
...
type extDesc struct {
	...
	Required bool
	// Declares in which kernel version the key was first introduced
	// or "0" if it predates 6.11
	Since string
}
