...
func CrossCheck(instanceName, snapSHA3_384, provenance string, snapSize uint64, si *snap.SideInfo, integrityData *snap.IntegrityData, model *asserts.Model, db Finder) (snapRev *asserts.SnapRevision, err error) {
