...
var (
	...
	validPublisher = regexp.MustCompile("^(?:[a-z0-9A-Z]{32}|[-a-z0-9]{2,28}|\\$[a-z](?:_?[a-z0-9])*)$") // account ids look like snap-ids or are nice identifiers, support our own special markers $MARKER
