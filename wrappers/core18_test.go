...
`, dirs.GlobalRootDir))
	...
	c.Check(s.sysdLog, DeepEquals, [][]string{
		...
		{"--root", dirs.GlobalRootDir, "stop", "usr-lib-snapd.mount"},
		{"--root", dirs.GlobalRootDir, "show", "--property=ActiveState", "usr-lib-snapd.mount"},
		{"--root", dirs.GlobalRootDir, "start", "usr-lib-snapd.mount"},
		{"daemon-reload"},
		...
		{"--root", dirs.GlobalRootDir, "stop", "snapd.autoimport.service"},
		{"--root", dirs.GlobalRootDir, "show", "--property=ActiveState", "snapd.autoimport.service"},
		{"--root", dirs.GlobalRootDir, "start", "snapd.autoimport.service"},
		{"--root", dirs.GlobalRootDir, "start", "snapd.service"},
		{"--root", dirs.GlobalRootDir, "start", "--no-block", "snapd.seeded.service"},
		{"--root", dirs.GlobalRootDir, "start", "--no-block", "snapd.autoimport.service"},
