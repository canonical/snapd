...
func (s *appSuite) testPostApps(c *check.C, inst servicectl.AppInstruction, systemctlCall []string) *state.Change {
...
func (s *appSuite) TestPostAppsStartOne(c *check.C) {
	inst := servicectl.AppInstruction{Action: "start", Names: []string{"snap-a.svc2"}}
...
func (s *appSuite) TestPostAppsStartTwo(c *check.C) {
	inst := servicectl.AppInstruction{Action: "start", Names: []string{"snap-a"}}
...
func (s *appSuite) TestPostAppsStartThree(c *check.C) {
	inst := servicectl.AppInstruction{Action: "start", Names: []string{"snap-a", "snap-b"}}
...
func (s *appSuite) TestPosetAppsStop(c *check.C) {
	inst := servicectl.AppInstruction{Action: "stop", Names: []string{"snap-a.svc2"}}
	expected := []string{"systemctl", "stop", "snap.snap-a.svc2.service"}
	s.testPostApps(c, inst, expected)
}

func (s *appSuite) TestPosetAppsRestart(c *check.C) {
	inst := servicectl.AppInstruction{Action: "restart", Names: []string{"snap-a.svc2"}}
