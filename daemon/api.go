...
var (
	...
	snapstateResolveValSetEnforcementError = func(context.Context, *state.State, *snapasserts.ValidationSetsValidationError, map[string]*asserts.ValidationSet, int) ([]*state.TaskSet, []string, error) {
