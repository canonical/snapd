...
func MockConfdbstateSetViaView(f func(confdb.Databag, *confdb.View, map[string]any, confdb.Visibility) error) (restore func()) {
...
func MockConfdbstateLoadConfdbAsync(f func(*state.State, *confdb.View, []string, map[string]string, confdb.Visibility) (string, error)) (restore func()) {
