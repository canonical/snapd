...
func (s *apiSuite) TestConnectionsByPlugSlotName(c *check.C) {
	restore := builtin.MockInterface(&ifacetest.TestInterface{InterfaceName: "test"})
	defer restore()
	restore = builtin.MockInterface(&ifacetest.TestInterface{InterfaceName: "different"})
	defer restore()
...
`
	...
	s.testConnections(c, "/v2/connections?select=all&name=slot", map[string]interface{}{
		"result": map[string]interface{}{
			"slots": []interface{}{
				map[string]interface{}{
					"snap":      "different-producer",
	...
	s.testConnections(c, "/v2/connections?select=all&name=plug", map[string]interface{}{
		"result": map[string]interface{}{
			"plugs": []interface{}{
				map[string]interface{}{
					"snap":      "consumer",
	...
	s.testConnections(c, "/v2/connections?name=plug", map[string]interface{}{
		"result": map[string]interface{}{
			"plugs": []interface{}{
				map[string]interface{}{
					"snap":      "consumer",
	...
	s.testConnections(c, "/v2/connections?name=slot", map[string]interface{}{
		"result": map[string]interface{}{
			"plugs": []interface{}{
				map[string]interface{}{
					"snap":      "consumer",
