...
require (
	...
	github.com/snapcore/secboot v0.0.0-20250711210843-36be1c6cc72a
...
replace github.com/snapcore/secboot => github.com/chrisccoulson/secboot v0.0.0-20250715200320-d3d72382cde1
