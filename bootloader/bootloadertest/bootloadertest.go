...
// function. Specifically, the panic will be done immediately entering the
// function so setting SetBootVars to panic will emulate a reboot before any
// boot vars are set persistently
