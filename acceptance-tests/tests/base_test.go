...
import (
	...
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/cli"
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/config"
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/partition"
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/report"
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/runner"
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/wait"
)
...
func setUpSnapd(c *check.C, fromBranch bool, extraEnv string) {
	...
	if fromBranch {
		binPath, err := filepath.Abs("acceptance-tests/bin/snapd")
...
func writeEnvConfig(extraEnv string) error {
	...
	trustedKey, err := filepath.Abs("acceptance-tests/data/trusted.acckey")
	if err != nil {
		return err
	}
