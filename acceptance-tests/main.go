...
import (
	...
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/autopkgtest"
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/build"
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/config"
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/image"
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/testutils"
)
...
const (
	...
	defaultChannel   = "edge"
	defaultSSHPort   = 22
	dataOutputDir    = "acceptance-tests/data/output/"
...
func main() {
	...
	test := &autopkgtest.AutoPkgTest{
		...
		AcceptanceTestName: build.AcceptanceTestName,
