...
import (
	...
	"github.com/ubuntu-core/snappy/acceptance-tests/testutils/tpl"
)

const (
	controlTpl    = "acceptance-tests/data/tpl/control"
...
type AutoPkgTest struct {
	...
	TestFilter string
	// AcceptanceTestName is the name of the binary that runs the acceptance tests.
	AcceptanceTestName string
...
func (a *AutoPkgTest) createControlFile() error {
	return tplExecute(controlTpl, controlFile,
		struct {
			...
			a.TestFilter, a.AcceptanceTestName})
}
