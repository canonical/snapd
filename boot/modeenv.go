...
type Modeenv struct {
	...
	// the list is a hash of an asset the system booted with (or is expected
	// to have booted with). The second entry, if present, is the hash of an
	// entry added when an update of the asset was applied (or is about to
	// be applied).
