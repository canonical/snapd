...
func (s *SnapTestSuite) TestAddPackageServicesStripsGlobalRootdir(c *C) {
	...
	baseDirWithoutRootPrefix := "/snap/" + helloSnapComposedName + "/1.10"
...
func (s *SnapTestSuite) TestAddPackageBinariesStripsGlobalRootdir(c *C) {
	...
	needle := `
ubuntu-core-launcher hello-snap.hello hello-snap_hello_1.10 /snap/hello-snap/1.10/bin/hello "$@"
`
...
[Service]
ExecStart=/usr/bin/ubuntu-core-launcher xkcd-webserver.xkcd-webserver xkcd-webserver_xkcd-webserver_0.3.4 /snap/xkcd-webserver/0.3.4/bin/foo start
Restart=on-failure
...
ExecStop=/usr/bin/ubuntu-core-launcher xkcd-webserver.xkcd-webserver xkcd-webserver_xkcd-webserver_0.3.4 /snap/xkcd-webserver/0.3.4/bin/foo stop
ExecStopPost=/usr/bin/ubuntu-core-launcher xkcd-webserver.xkcd-webserver xkcd-webserver_xkcd-webserver_0.3.4 /snap/xkcd-webserver/0.3.4/bin/foo post-stop
TimeoutStopSec=30
%[2]s
...
func (s *SnapTestSuite) TestSnappyGenerateSnapServiceTypeForking(c *C) {
	...
	pkgPath := "/snap/xkcd-webserver/0.3.4/"
...
func (s *SnapTestSuite) TestSnappyGenerateSnapServiceWrapperWhitelist(c *C) {
	...
	pkgPath := "/snap/xkcd-webserver.canonical/0.3.4/"
