...
func generateSnapServicesFile(app *snap.AppInfo, baseDir string) (string, error) {
	...
	desc := fmt.Sprintf("service %s for snap %s - autogenerated DO NO EDIT", app.Name, app.Snap.ZName())
...
func generateServiceFileName(app *snap.AppInfo) string {
	return filepath.Join(dirs.SnapServicesDir, fmt.Sprintf("%s_%s_%s.service", app.Snap.ZName(), app.Name, app.Snap.Version))
}

func generateSocketFileName(app *snap.AppInfo) string {
	return filepath.Join(dirs.SnapServicesDir, fmt.Sprintf("%s_%s_%s.socket", app.Snap.ZName(), app.Name, app.Snap.Version))
}

func generateBusPolicyFileName(app *snap.AppInfo) string {
	return filepath.Join(dirs.SnapBusPolicyDir, fmt.Sprintf("%s_%s_%s.conf", app.Snap.ZName(), app.Name, app.Snap.Version))
}
