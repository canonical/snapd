...
// TODO:FDEM:FIX Point back to master after fde branch is merged.
...
require (
	...
	github.com/canonical/go-efilib v1.3.1 // indirect
	...
	github.com/snapcore/secboot v0.0.0-20241115151056-b3ae5175dc9b // indirect
