...
nested_check_boot_errors() {
    ...
    if nested_is_core_20_system && ! nested_check_unit_active "$NESTED_VM" 15 1; then
        ...
        # It is reproducable on an Intel machine without unrestricted mode support, the failure is most likely due to the guest entering an invalid state for Intel VT
